...
import TableImportOutwardInvoice from '@/components/Outward/OutwardInvoice/Import/TableImportOutwardInvoice.vue'
  ...
  methods: {
    ...
    async handleAction(key) {
      ...
      if (key === 'okSaveDetail') {
        ...
        return this.$emit('update-invoice-details', selectedItems)
      }
      if (key === 'closeImport') {
