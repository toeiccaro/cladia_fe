...
export default {
  ...
  methods: {
    ...
    calculateBalanceQty(itemRow) {
      const qty = this.parseStringToFloat(itemRow.subQuantity)
      const deliveredQty = this.parseStringToFloat(itemRow?.deliveredQuantity)
      itemRow.balanceQty = qty - deliveredQty
    },
