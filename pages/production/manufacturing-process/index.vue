...
import TableManufacturingProcess from '@/components/Production/ManufacturingProcess/TableManufacturingProcess.vue'
...
export default {
  ...
  methods: {
    ...
    exportAll() {
      ...
      const sortFilter = this.payloadManufacturingProcess
    ...
    handleEdit() {
      this.currentId &&
        this.$router.push({
          path: `/${this.$i18n.locale}/production/manufacturing-process/detail?orderNo=${this.currentId}`,
        })
    },
    handleSet() {
