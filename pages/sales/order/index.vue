...
import TableOrders from '@/components/Sale/Order/TableOrders.vue'
import api from '@/api/api'
import { downloadFileExcel } from '@/utils/utils'
import BaseSetColumn from '~/components/UI/BaseSetColumn.vue'

export default {
  components: { ToolBar, TableOrders, BaseSetColumn },
  ...
  methods: {
    ...
    async handleExportExcel(sortFormOptional) {
      this.loading = true
      const response = await api('exportOrder', sortFormOptional)
      this.loading = false
